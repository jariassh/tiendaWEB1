            ...
            <div class="row">
                ...
                <div class="form-group col-8 mt-3">
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="https://url-Image...">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-6">
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Descripci&oacute;n Procesador...">
                    </div>
                </div>                  
                <div class="form-group col-6">                
                    <div class="input-group mb-2">
                ...
                <div class="form-group col-4">                
                    ...
                    <div class="form-group col-4">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Costo...">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-12">
                        <div class="input-group mb-2" id="txtDetallesProducto">                            
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" placeholder="Escriba detalles adicionales..."></textarea>
                        </div>
                    </div>
                </div>
                <div class="row d-flex justify-content-center">
